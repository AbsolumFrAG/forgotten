...
import createLevel from "../utilities/createLevel";
import populateLevel from "../utilities/populateLevel";
...
export default class LevelScene extends Phaser.Scene {
    ...
    create() {
        ...
        //Player collisions
        this.physics.add.collider(this.player.sprite, this.midground, (a, b) => this.player.checkWall(), null, this);
